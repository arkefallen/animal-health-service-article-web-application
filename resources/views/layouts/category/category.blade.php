...
<body>
  ...
  <div class="sm:ml-64 pt-16 px-8">
    ...
    <div class="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3">
      <button id="addCategoryModalButton" data-modal-target="addCategoryModal" data-modal-toggle="addCategoryModal" type="button" class="flex items-center justify-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
  ...
  <!-- <section class="justify-center h-screen flex items-center ">
    <div class="rounded-lg bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 p-0.5 sm:basis-11/12 md:basis-4/5 lg:basis-3/4">
      <div class="rounded-lg bg-white p-8 shadow-lg">
        ...
        <a class="inline-block rounded-full border border-indigo-600 p-3 text-indigo-600 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500" href="">
