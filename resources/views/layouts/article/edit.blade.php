...
<body>
  <section class="bg-white dark:bg-gray-900">
    ...
    <x-failed-popup-notification :session_status="Session::has('failed_update')" session_title="Gagal update data" :session_message="Session::get('failed_update')" />
      ...
      <h2 class="mt-8 mb-4 text-xl font-bold text-gray-900 dark:text-white">Ubah Data Artikel</h2>
