<aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-blue-900 border-r border-gray-900 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700" aria-label="Sidebar">
  <div class="h-full px-3 pb-4 overflow-y-auto bg-blue-900">
    <ul class="space-y-2 font-medium">
      <li>
        <a href="{{ route('dashboard') }}" class="flex items-center p-2 rounded-lg text-white hover:bg-blue-950 group">
      ...
      <li>
        <a href="{{ route('article') }}" class="flex items-center p-2 rounded-lg text-white hover:bg-blue-950 dark:hover:bg-blue-950 group">
      ...
      <li>
        <a href="{{ route('category') }}" class="flex items-center p-2 rounded-lg text-white hover:bg-blue-950 dark:hover:bg-blue-950 group">
          <svg class="flex-shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
      ...
      <li>
        <a href="{{ route('review') }}" class="flex items-center p-2 rounded-lg text-white hover:bg-blue-950 dark:hover:bg-blue-950 group">
          <svg class="flex-shrink-0 w-5 h-5 transition duration-75 text-gray-400 group-hover:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
