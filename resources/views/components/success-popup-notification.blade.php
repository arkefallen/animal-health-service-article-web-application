@props(['session_status', 'session_title', 'session_message'])
...
<div class="rounded-xl border border-gray-100 bg-white p-4 alert mb-4" role="alert">
    <div class="flex items-start gap-4">
        ...
        <div class="flex-1">
            <strong class="block font-medium text-gray-900">{{ $session_title }}</strong>

            <p class="mt-1 text-sm text-gray-700">{{ $session_message }}</p>
        </div>
